...
const LOCALES = {
  ...
  de: {
    drinks: { beer: 'Bier', wine: 'Wein', sparkling_wine: 'Sekt', cider: 'Cidre', spirits: 'Spirituosen', cocktail: 'Cocktail', liqueur: 'Likör', fortified_wine: 'Likörwein', custom: 'Eigene Eingabe' },
  ...
  es: {
    drinks: { beer: 'Cerveza', wine: 'Vino', sparkling_wine: 'Espumoso', cider: 'Sidra', spirits: 'Destilados', cocktail: 'Cóctel', liqueur: 'Licor', fortified_wine: 'Vino fortificado', custom: 'Personalizado' },
  ...
  id: {
    drinks: { beer: 'Bir', wine: 'Anggur', sparkling_wine: 'Sparkling wine', cider: 'Sider', spirits: 'Minuman keras', cocktail: 'Koktail', liqueur: 'Liqueur', fortified_wine: 'Anggur fortifikasi', custom: 'Kustom' },
